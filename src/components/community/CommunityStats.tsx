      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-black/5 overflow-hidden border border-gray-100 flex flex-col md:flex-row animate-in h-full">
              <div className="p-8 md:p-12 flex-1 flex flex-col justify-center">
                <div className="w-14 h-14 bg-brand-green rounded-full flex items-center justify-center text-brand-primary mb-6">
                  <Leaf size={28} />
                </div>
                <h3 className="text-3xl font-serif font-bold text-brand-green mb-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {statsSection.stats.map((stat: any, index: number) => (
                  <div key={index} className="text-center md:text-left">
                    ...
                    <div className="text-xs md:text-sm text-white/60 font-medium uppercase tracking-wider">
                      {stat.label}
                    </div>
                  </div>
                ))}
