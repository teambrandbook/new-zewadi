      ...
      <div className="container mx-auto px-6 lg:px-32">
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <h2 className="text-[#121414] text-4xl lg:text-[54px] font-serif leading-[1.1] mb-6">
              Where Food Meets<br />Meaning
            </h2>

            <p className="text-[#121414] text-[14px] font-normal font-sans leading-relaxed mb-12 max-w-[460px]">
            ...
            <div className="relative w-full aspect-[16/8] mb-12 overflow-hidden shadow-sm">
              <Image
                src="/home/meaningImg2.png"
                alt="Shared meals"
                fill
          ...
          <div className="w-full lg:w-1/2 pt-12">
            <div className="relative w-full aspect-[3/4] lg:h-[600px] overflow-hidden shadow-sm">
              <Image
                src="/home/meaningImg1.png"
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end mt-12 gap-8">
          <p className="text-[#121414] text-[15px] font-normal font-sans leading-relaxed max-w-[580px]">
