      ...
      <div className="bg-[#244d3a] w-full pt-0 pb-0 lg:pt-18 lg:pb-0">
        <div className="container mx-auto px-6 lg:px-20 relative flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-start z-10 ">
            <h2 className="text-[#d9c5a7] text-4xl lg:text-[54px] font-bold font-['Playfair_Display'] leading-[1.1] mb-6 tracking-tight fade-in">
              LEARN MORE<br />
              ABOUT ZEWADI
            </h2>
            
            <p className="text-white/90 text-sm lg:text-[16px] font-normal font-['Inter'] leading-relaxed mb-10 max-w-[440px] fade-in">
